...
/*
	...
	인덱스로 관리, 순차처리, 앞에서부터 자료를 기억, 자료의 삽입/삭제시 많은 시간 소요될수 있음. 중복허용됨
...
public class Test1 {
	public static void main(String[] args) {
		...
		System.out.println("1.vector : " + vector.toString());
		...
		System.out.println("4.vector.get(마지막인덱스번호) : " + vector.get(vector.size()-1));
		System.out.println();
		...
		System.out.println("4.vector : " + vector);
		System.out.println();
