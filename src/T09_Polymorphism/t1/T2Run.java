...
public class T2Run {
	public static void main(String[] args) {
		...
		//Cc cc = a1; //처음부처 부모가 자식객체로 타입변환될수는 없다.
		
		//부모객체가 자식객체로 타입변환을 하기위해서는 무조건 자식객체가 부모타입으로 변환했을때 가능하다.(강제 Casting)
		Bb bb = new Bb();
		...
		//Cc 객체가 Aa로 타입변환된 적이 없기에, a2객체는 Cc객체로 타입변환불가이다.(컴파일상에서는 에러가 발생하지 않는다.-실행오류)
		//Cc c1 = (Cc)a2;
