...
insert into test values (default,'아톰',35,'남자','제주');
insert into test values (default,'강감찬',42,'남자','인천');
insert into test values (default,'이사랑',21,'여자','서울');
insert into test values (default,'강소연',19,'여자','청주');
insert into test values (default,'고릴라',38,'여자','제주');
insert into test values (default,'김감자',41,'남자','서울');
insert into test values (default,'이자바',39,'남자','청주');
